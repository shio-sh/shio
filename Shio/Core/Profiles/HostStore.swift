...
enum ShioModelContainer {
    ...
    static let shared: ModelContainer = {
        ...
        do {
            let container = try ModelContainer(for: Host.self, Project.self, ProjectCheckout.self, configurations: cloudConfig)
        ...
        if let container = try? ModelContainer(for: Host.self, Project.self, ProjectCheckout.self, configurations: localConfig) {
        ...
        if let container = try? ModelContainer(for: Host.self, Project.self, ProjectCheckout.self, configurations: inMemoryConfig) {
