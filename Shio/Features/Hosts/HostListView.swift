    ...
    private var emptyState: some View {
        VStack(spacing: ShioSpace.lg) {
            ...
            Text("Add a machine")
                ...
                .foregroundStyle(ShioTheme.textPrimary)
            Text("Add your Mac, or any machine you can SSH into. Pair over your network, or reach it anywhere with Tailscale.")
        ...
        HStack(spacing: ShioSpace.md) {
            ...
            VStack(alignment: .leading, spacing: 2) {
                Text(host.name)
                    ...
                    .foregroundStyle(ShioTheme.textPrimary)
                Text("\(host.username)@\(host.hostname) · \(host.kind.displayName)")
