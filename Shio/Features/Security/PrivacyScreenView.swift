...
/// Generic dark splash shown over Shio's UI when the app resigns active
/// (background, app switcher, control center). Prevents the live terminal
/// from being captured in the iOS app-switcher snapshot.
///
/// This is intentionally minimal — just the shio wordmark on a solid dark
/// background. No info leakage about which Mac you were on or what was on
/// screen.
